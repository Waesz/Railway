...
public class PlanningGestion  implements Initializable{
	...
	/*
   public PlanningGestion(String nom) {
		super(nom);
...
*/
	 ...
	 * @author lry41 
	 * @version 1.0
	 * @return donnée du client avec sql
	 * 
	 */
	public static void addNom(Client a ) {
		/*System.out.println("son nom est"+a.nom);
		return a.nom;
*/
		...
		String sql="SELECT * FROM Personne2 WHERE nom=?";
				try {
					stat = con.prepareStatement(sql);
					
					stat.setString(1, a.nom); 
