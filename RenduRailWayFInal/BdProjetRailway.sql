...
--
-- Host: localhost:8889
-- Generation Time: Dec 14, 2020 at 09:39 PM
...
(102, 'Train', 109, 2, 1, '2020-12-24 12:36:43', '2020-12-30 12:36:43', 12, 12, 0, 1),
(103, 'train', 108, 3, 134, '2020-12-26 12:32:43', '2020-12-26 12:32:43', 12, 123, 0, 1);
...
INSERT INTO `Personne2` (`id_personne`, `nom`, `prénom`, `mdp`, `email`, `typeAbo`, `admin`, `RecetteMonth`, `Solde`) VALUES
(1, 'Leroy', 'geoffrey', '1234', 'geo@orange.fr', '0', 0, NULL, 367.15),
(2, 'AA', 'aa', '12345', 'a', '0', 1, NULL, NULL),
(39, 'Bang', 'Niro', 'aaaaaaaaaaa', 'niro@orange.fr', NULL, NULL, NULL, NULL),
(45, 'admin1', 'adminS', 'admin', 'admin@orange.fr', NULL, NULL, NULL, NULL),
(46, 'lamy', 'jessica', 'loulou238', 'jessica.lamy13@gmail.com', NULL, NULL, NULL, NULL),
(47, 'a', 'fa', '123456789', 'geo@orange.fa', NULL, NULL, NULL, NULL),
(48, '', '', 'ADMIN123456', 'Admin@orange.fr', '0', 1, 1200, NULL),
(49, 'leroy', 'geoffrey', '12345678', 'geo@orange.fr', NULL, NULL, NULL, NULL),
(50, 'leroy', 'geoffrey', '12345678', 'geo@orange.fr', NULL, 1, NULL, NULL),
(51, 'Messi', 'Lionnel', 'GEOFFREY1', 'messilegrand@orange.fr', NULL, NULL, NULL, NULL),
(52, 'Lamy', 'Jessiva', '12345678', 'jessica@orange.fr', NULL, NULL, NULL, NULL),
(53, 'Lamy', 'Jessiva', '12345678', 'jessica@orange.fr', NULL, NULL, NULL, NULL),
(54, 'lamy', 'jessica', '12345678', 'jessica@orange.fr', NULL, NULL, NULL, NULL),
(55, 'lamy', 'jessica', '12345678', 'jessica@orange.fr', NULL, NULL, NULL, NULL),
(56, 'aa', 'aa', 'aaaaaaaaaaa', 'aa@orange.fr', NULL, 1, NULL, NULL),
(57, 'test', 'test', '12345678', 'test@orange.fr', NULL, 1, NULL, NULL);
...
--
ALTER TABLE `ligne`
  MODIFY `idligne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
...
--
ALTER TABLE `train`
  MODIFY `idtrain` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
